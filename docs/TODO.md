...
- [ ] **Add ReservationAgent unit tests** — Complex tool execution logic (9 tool handlers) has zero test coverage. Test each handler: search, availability, booking, conflict resolution, sniper scheduling, view jobs.
